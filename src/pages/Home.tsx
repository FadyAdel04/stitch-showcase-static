  ...
  const testimonials = [
    {
      name: "Sarah Chen",
      comment:
        "Absolutely love the quality and attention to detail. The fit is perfect!",
      rating: 5,
    },
    {
      name: "Marcus Thompson",
      comment:
        "Finally found a brand that combines style with comfort. Highly recommend!",
      rating: 5,
    },
    {
      name: "Elena Rodriguez",
      comment:
        "The materials are luxurious and the designs are timeless. Worth every penny.",
      rating: 5,
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <Badge
            variant="outline"
            className="bg-background/80 text-charcoal border-charcoal mb-6"
          >
            New Collection 2024
          </Badge>
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Discover our curated collection of sophisticated pieces designed for
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="minimal"
              size="xl"
              className="bg-white/10 backdrop-blur-sm border-white text-white hover:bg-white hover:text-charcoal"
            >
              Explore Collection
            </Button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-background/5 rounded-lg p-6 backdrop-blur-sm"
              >
