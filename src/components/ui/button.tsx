  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background hover:bg-sage-light hover:text-charcoal shadow-soft",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-soft",
        ghost: "hover:bg-sage-light hover:text-charcoal",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-accent text-white hover:shadow-medium hover:scale-105 transform shadow-soft",
        sage: "bg-sage text-white hover:bg-sage/90 shadow-soft",
        minimal: "bg-transparent border border-charcoal text-charcoal hover:bg-charcoal hover:text-cream shadow-soft",
      },
      size: {
